...
public class LessonAdapter extends RecyclerView.Adapter<LessonAdapter.LessonViewHolder> {
    ...
    class LessonViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ListeningLesson lesson, UserProgress progress) {
            ...
            if (progress != null) {
                ...
                if (progress.getStatus().equals("COMPLETED")) {
                    ...
                    tvBestScore.setText(String.format("Best: %.0f%%", progress.getBestScore()));
                } else {
        ...
        private String getStatusText(String status) {
            switch (status) {
                case "COMPLETED":
                    return itemView.getContext().getString(R.string.completed);
                case "IN_PROGRESS":
                    return itemView.getContext().getString(R.string.in_progress);
                default:
                    return itemView.getContext().getString(R.string.not_started);
            }
        }
